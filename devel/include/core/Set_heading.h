...
bool operator==(const ::core::Set_heading_<ContainerAllocator1> & lhs, const ::core::Set_heading_<ContainerAllocator2> & rhs)
{
  return lhs.enable_heading_ctrl == rhs.enable_heading_ctrl &&
