...
echo_and_run cd "/home/bluerov/Schreibtisch/BlueROV2/src/tritech_micron"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/bluerov/Schreibtisch/BlueROV2/src/tritech_micron/setup.py" \
     \
    build --build-base "/home/bluerov/Schreibtisch/BlueROV2/build/tritech_micron" \
    install \
    --root="${DESTDIR-/}" \
